...
description: 'NestJS base practices - complementa regras DDD/Clean Architecture do projeto'
---

# NestJS Base Practices + DDD Enhancements

> ⚠️ **CONTEXTO IMPORTANTE:**
> Este arquivo fornece práticas **BASE do NestJS** (dependency injection, decorators, módulos).
> 
> **Para regras específicas de DDD/Clean Architecture (PRIORIDADE), consulte:**
> - `modules-domain.instructions.md` → Value Objects, Entities puras (sem TypeORM)
> - `modules-application.instructions.md` → Use Cases (orchestration, não business logic)
> - `modules-infrastructure.instructions.md` → ORM Entities, Repositories, Mappers
> - `modules-presentation.instructions.md` → Controllers magros, DTOs
>
> **HIERARQUIA:** Regras específicas DDD > Este arquivo base
...
> ⚠️ **ADAPTAÇÃO DDD:** No contexto deste projeto:
> - Services NestJS = **Use Cases** (application layer)
> - Business logic = **Domain Entities/Value Objects** (domain layer)
> - Consulte `modules-application.instructions.md` para padrão correto
...
> ⚠️ **ADAPTAÇÃO DDD:** Neste projeto:
> - Separamos **Domain Entity** (pura) vs **ORM Entity** (TypeORM decorators)
> - Repositories implementam interfaces definidas no domain
> - Mappers convertem ORM Entity ↔ Domain Entity
> - Consulte `modules-infrastructure.instructions.md`
