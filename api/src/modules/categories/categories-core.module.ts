...
import { ProvisionDefaultCategoriesUseCase } from './application/use-cases/provision-default-categories/provision-default-categories.use-case';
...
@Module({
  ...
  providers: [
    { provide: ICategoryRepository, useClass: CachedCategoryRepository },
    CategoryRepository,
