...
- O estagio final da imagem fixa uma versao corrigida do npm compativel com Node.js 24, pois o npm fornecido pela imagem base tambem faz parte da superficie analisada pelo Trivy e e necessario em operacoes de producao.
