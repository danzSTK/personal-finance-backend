...
# Estudo inicial de Object Storage

> Rascunho histórico preservado para registrar o raciocínio inicial. Não use este arquivo como referência operacional ou como descrição do estado atual.
